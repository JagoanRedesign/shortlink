...
<body>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Example: https://www.bloggerbyte.net/" id="text">
  ...
  <script src="https://cdn.jsdelivr.net/gh/rooplal/shortlink@main/main.min.js" crossorigin="anonymous"></script>
</body>
</html>
